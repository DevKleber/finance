...
class DespesaItemController extends Controller
{
    ...
    {
        $despesaItem = \App\DespesaItem::where('id_usuario', $this->token['id_usuario'])->get();
        if(!$despesaItem){
    ...
    {
        $despesaItem =  \App\DespesaItem::find($id)->where('id_usuario', $this->token['id_usuario']);
        if(!$despesaItem){
    ...
    public function update(Request $request, $id)
    {
        ...
        if($despesaItem){
            if($despesaItem['id_usuario'] != $this->token['id_usuario']){
