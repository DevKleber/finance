...
class ContaController extends Controller
{
    ...
    {
        $conta = \App\Conta::where('id_usuario', $this->token['id_usuario'])->get();
        if(!$conta){
    ...
    {
        $conta =  \App\Conta::find($id)->where('id_usuario', $this->token['id_usuario']);
        if(!$conta){
    ...
    public function update(Request $request, $id)
    {
        ...
        if($conta){
            if($conta['id_usuario'] != $this->token['id_usuario']){
