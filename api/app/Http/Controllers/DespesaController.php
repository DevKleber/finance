...
class DespesaController extends Controller
{
    ...
    {
        $despesa = \App\Despesa::where('id_usuario', $this->token['id_usuario'])->get();
        if(!$despesa){
    ...
    {
        $despesa =  \App\Despesa::find($id)->where('id_usuario', $this->token['id_usuario']);
        if(!$despesa){
    ...
    public function update(Request $request, $id)
    {
        ...
        return $despesa;
        if($despesa){
            if($despesa['id_usuario'] != $this->token['id_usuario']){
