...
class ReceitaController extends Controller
{
    ...
    {
        $receita = \App\Receita::where('id_usuario', $this->token['id_usuario']);
        if(!$receita){
    ...
    {
        $receita =  \App\Receita::find($id)->where('id_usuario', $this->token['id_usuario']);
        if(!$receita){
    ...
    public function changeBoRepetir(Request $request, $id){
        ...
        if($receita){
            ...
            $receita->bo_repetir = ($request->bo_repetir==='true')?true:false;
